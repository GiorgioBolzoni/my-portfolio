  ...
  data() {
    return {
      projects: [
        ...
        {name: 'Gobike', stack: 'Front End', src: '/my-portfolio/img/bike.gif', alt: 'gobike.gif', technology: 'Vue.js | Sass | Bootstrap | API', link: 'https://github.com/GiorgioBolzoni/proj-html-vuejs', site: 'https://gobike.netlify.app/'},
